...
const Comment = ({ commentData, noPhoto, noTimestamp, noLike, noLikesCounter, noRemove, setLikesWindow, refreshComments}) =>
{
	...
	const getCommenterInfo = async () =>
	{
		...
		// TODO: Get commenter's data and return it
	};
	...
	const removeComment = async () =>
	{
		try
		{
			...
			setIsLoading(true);
			// TODO: Delete the comment from the comments table
