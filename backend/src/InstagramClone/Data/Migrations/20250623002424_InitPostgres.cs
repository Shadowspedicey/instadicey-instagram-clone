        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePic = table.Column<string>(type: "text", nullable: true, defaultValue: "jGLe0Lx39svW1MiJObFkD6w1S-gigSJuJ0WfcA0BpE4"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserID = table.Column<string>(type: "text", nullable: false),
                    Token = table.Column<string>(type: "character varying(45)", maxLength: 45, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserID = table.Column<string>(type: "text", nullable: false),
                    SearchedUserID = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LikedPostID = table.Column<string>(type: "character varying(26)", nullable: false),
                    UserID = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SavedPostID = table.Column<string>(type: "character varying(26)", nullable: false),
                    UserID = table.Column<string>(type: "text", nullable: false),
